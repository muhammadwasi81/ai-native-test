...
async function main() {
          ...
          content: [
            ...
            },
            {
              ...
              content: [
                {
                  type: "text",
                  text: "This is a seeded document. Try the toolbar: ",
                },
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Create new documents" }],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [
                        { type: "text", text: "Upload .txt / .md / .docx" },
                      ],
                    },
                  ],
                },
  ...
  console.log(
    "Seed complete. Users: alice@demo.test, bob@demo.test, carol@demo.test (password: demo1234)",
  );
}
